...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-11-2019 a las 03:39:50
...
(1, ' Little Women', 7, ' 1868', ' Literatura Juvenil', 'relato en parte autobiográfico inspirado en su niñez junto a sus hermanas en Concord, Massachusetts. Esta obra fue escrita por encargo de su editor, que quería un libro orientado a mujeres jóvenes.', 4),
...
INSERT INTO `usuarios` (`id_usuario`, `username`, `pass`, `nombre`, `fecha_nac`, `mail`) VALUES
(1, 'cla', '$2y$10$W08bqR7Dk0FrtXvAVMo26.ozKOaT9wZRckVC93vDgCOW2vO8oyT2C', 'clara', '28/01', 'clara@algo.com');
